...
import com.diotegar.movie.adapter.AdapterMovie
import com.diotegar.movie.model.Movie
import com.diotegar.movie.service.ApiMovie
...
class MainActivity : AppCompatActivity() {
    ...
    private var adapterTheMovieDb by Delegates.notNull<AdapterMovie>()
    ...
    private fun doLoadData() {
        ...
        val retrofit = Retrofit.Builder()
            ...
            .build()
        val apiTheMovieDb = retrofit.create(ApiMovie::class.java)
        apiTheMovieDb.getNowPlaying(page = page)
            ...
            .subscribe(
                { theMovieDb: Movie ->
                    ...
                    if (page == 1) {
                        adapterTheMovieDb = AdapterMovie(
                            this@MainActivity,
                            resultTheMovieDb
                        )
